// app/dashboard/[id]/aeo/page.tsx — WO-003 Stream M holding page.
    ...
    <main style={{ padding: "40px 32px 64px" }}>
      <div style={{ maxWidth: 1180 }}>
        <ClientHeader id={params.id} name={client.name} domain={client.domain} tier={client.tier}
          clientType={type} active="aeo" />
        <BeingBuilt
          title="AI answer visibility"
          reason="Where this client shows up when buyers ask AI, and where they do not."
          waitingOn="The client-facing view. Prompt checks are already running daily; the numbers need verifying against the platforms before they are shown."
