// app/dashboard/[id]/changes/page.tsx — WO-003 Stream M holding page.
...
export default async function Changes({ params }: { params: { id: string } }) {
  const db = userClient();
    ...
    <main style={{ padding: "40px 32px 64px" }}>
      <div style={{ maxWidth: 1180 }}>
        ...
        <BeingBuilt
          ...
          reason="Every change, who decided it, and what it did after 28 days."
