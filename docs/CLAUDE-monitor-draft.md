# DRAFT — Growth OS Monitor · Agent Operating Brief

> **Status: awaiting Tom's approval.** Derived from `docs/tm-growth-os-plan.md` §8
> (Governance & guardrails) + WO-001 §4 (Branch/agent conventions), per CTO
> decision 2026-07-21. Once approved, this replaces the stale WordPress-theme
> `CLAUDE.md` at repo root as the standing brief for `tm-seo-monitor`.
